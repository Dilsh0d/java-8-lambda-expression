...
public class PredicateExample {
    ...
    public static void predicateOr() {
        System.out.println("Predicate Or result is : "+p1.or(p2).test(15));// predicate chaining
    ...
    public static void predicateNegate() {
        ...
        System.out.println("Predicate Negate result is : "+p1.and(p2).negate().test(8));// predicate chaining
    }
